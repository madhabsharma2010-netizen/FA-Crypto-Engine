...
EVENT_HISTORY_FILE = Path(
    "logs/backtests/v3e6_development_event_history.csv"
)
SUMMARY_FILE = Path(
    "reports/v3e6_development_summary.csv"
)
SYMBOL_SUMMARY_FILE = Path(
    "reports/v3e6_development_symbol_summary.csv"
)
...
def run_backtest() -> dict[str, Any]:
    print("=" * 126)
    print("FA CRYPTO ENGINE — V3E6 SELECTIVE STRATEGY DEVELOPMENT")
    print("=" * 126)
    print(
    ...
    print()
    print("=" * 126)
    print("FA CRYPTO ENGINE — V3E6 DEVELOPMENT RESULT")
    print("=" * 126)

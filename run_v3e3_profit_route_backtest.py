...
# ============================================================================
# V3E3 PORTFOLIO SETTINGS — V3D3 RISK/EXIT ENGINE FROZEN
# ============================================================================
...
EVENT_HISTORY_FILE = Path(
    "logs/backtests/v3e3_portfolio_event_history.csv"
)
SUMMARY_FILE = Path(
    "reports/v3e3_portfolio_backtest_summary.csv"
)
SYMBOL_SUMMARY_FILE = Path(
    "reports/v3e3_portfolio_symbol_summary.csv"
)
...
def run_backtest() -> dict[str, Any]:
    print("=" * 126)
    print("FA CRYPTO ENGINE — V3E3 CONTROLLED MULTI-ROUTE PROFIT BACKTEST")
    print("=" * 126)
    ...
    print()
    print("=" * 126)
    print("FA CRYPTO ENGINE — V3E3 PORTFOLIO RESULT")
    print("=" * 126)
...
if __name__ == "__main__":
    try:
        ...
        print()
        print("V3E3 portfolio backtest stopped manually.")

    except Exception as error:
        print()
        print("=" * 126)
        print("V3E3 PORTFOLIO BACKTEST ERROR")
        print("=" * 126)

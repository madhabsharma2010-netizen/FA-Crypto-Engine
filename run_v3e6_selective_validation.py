...
# ============================================================================
# V3E6 SELECTIVE VALIDATION — V3D3 RISK/EXIT ENGINE FROZEN
# ============================================================================
...
EVENT_HISTORY_FILE = Path(
    "logs/backtests/v3e6_validation_event_history.csv"
)
SUMMARY_FILE = Path(
    "reports/v3e6_validation_summary.csv"
)
SYMBOL_SUMMARY_FILE = Path(
    "reports/v3e6_validation_symbol_summary.csv"
)
...
def run_backtest() -> dict[str, Any]:
    print("=" * 126)
    print("FA CRYPTO ENGINE — V3E6 SELECTIVE STRATEGY VALIDATION")
    print("=" * 126)
    ...
    print()
    print("=" * 126)
    print("FA CRYPTO ENGINE — V3E6 VALIDATION RESULT")
    print("=" * 126)
...
if __name__ == "__main__":
    try:
        ...
        print()
        print("V3E6 validation stopped manually.")

    except Exception as error:
        print()
        print("=" * 126)
        print("V3E6 VALIDATION ERROR")
        print("=" * 126)

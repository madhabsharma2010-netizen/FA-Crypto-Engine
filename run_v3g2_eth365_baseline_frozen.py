...
TRADE_HISTORY_FILE = Path(
    "logs/backtests/v3g2_eth365_baseline_trades.csv"
)
EVENT_HISTORY_FILE = Path(
    "logs/backtests/v3g2_eth365_baseline_events.csv"
)
SUMMARY_FILE = Path(
    "reports/v3g2_eth365_baseline_summary.csv"
)
SYMBOL_SUMMARY_FILE = Path(
    "reports/v3g2_eth365_baseline_symbols.csv"
)
...
def run_backtest() -> dict[str, Any]:
    ...
    print("Risk/exit engine: V3D3 frozen baseline")

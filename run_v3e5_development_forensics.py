...
DETAIL_FILE = Path(
    "reports/v3e5_development_route_asset_forensics.csv"
)

ROUTE_FILE = Path(
    "reports/v3e5_development_route_summary.csv"
)

SYMBOL_FILE = Path(
    "reports/v3e5_development_symbol_summary_forensics.csv"
)

EXIT_FILE = Path(
    "reports/v3e5_development_exit_reason_summary.csv"
)

SCORE_FILE = Path(
    "reports/v3e5_development_score_bucket_summary.csv"
)

RR_FILE = Path(
    "reports/v3e5_development_rr_bucket_summary.csv"
)
...
def edge_label(
    ...
    # Discovery period must provide a meaningful sample.
    if trades < 8:
...
def main() -> None:
    ...
    print("=" * 150)
    print(
        "FA CRYPTO ENGINE — V3E5 DEVELOPMENT ROUTE/ASSET FORENSICS"
    )
    print("=" * 150)
...
if __name__ == "__main__":
    try:
        ...
        print()
        print(
            "V3E5 development forensics stopped manually."
        )
        ...
        print("=" * 150)
        print(
            "V3E5 DEVELOPMENT FORENSIC ERROR"
        )
        print("=" * 150)
        print(
